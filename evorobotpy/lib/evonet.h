...
public:
	...
	Evonet();
	// Other constructor
	Evonet(int ninputs, int nhiddens, int noutputs, int nlayers=1, int bias=0, int netType=0, int actFunct=1, int linOut=0, int wInit=0, int clip=0, int normalize=0, int randAct=0, double wrange=1.0, int nbins=1, double low=1.0, double high=1.0);
	// Destructor
	~Evonet();
