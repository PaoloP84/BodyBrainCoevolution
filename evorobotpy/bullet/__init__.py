...
register(id='EmbryoBulletEnv-v0',
         entry_point='pybullet_envs.gym_locomotion_envs:EmbryoBulletEnv',
         max_episode_steps=1000)

register(id='EmbryoHardBulletEnv-v0',
         entry_point='pybullet_envs.gym_locomotion_envs:EmbryoHardBulletEnv',
         max_episode_steps=1000)

register(id='EmbryoChallengingBulletEnv-v0',
         entry_point='pybullet_envs.gym_locomotion_envs:EmbryoChallengingBulletEnv',
         max_episode_steps=1000)

register(id='SumoBulletEnv-v0',
         entry_point='pybullet_envs.gym_locomotion_envs:SumoBulletEnv',
         max_episode_steps=1000)
