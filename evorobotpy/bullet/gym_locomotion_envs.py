...
import numpy as np
import pybullet
from robot_locomotors import Hopper, Walker2D, HalfCheetah, Ant, Humanoid, HumanoidFlagrun, HumanoidFlagrunHarder, Embryo, EmbryoHard, EmbryoChallenging, Sumo
...
class EmbryoBulletEnv(WalkerBaseBulletEnv):

  def __init__(self, render=False):
    self.robot = Embryo()
    WalkerBaseBulletEnv.__init__(self, self.robot, render)

class EmbryoHardBulletEnv(WalkerBaseBulletEnv):

  def __init__(self, render=False):
    self.robot = EmbryoHard()
    WalkerBaseBulletEnv.__init__(self, self.robot, render)

class EmbryoChallengingBulletEnv(WalkerBaseBulletEnv):

  def __init__(self, render=False):
    self.robot = EmbryoChallenging()
    WalkerBaseBulletEnv.__init__(self, self.robot, render)

class SumoBulletEnv(WalkerBaseBulletEnv):
